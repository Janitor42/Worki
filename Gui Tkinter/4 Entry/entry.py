...
tk.Button(win,text='get',command=get_entry).grid(row=1,column=1,stick='we')#создание кнопки - фун-ция которой отлавливать
# что находится в name проходить условия и печатать в консоль

tk.Button(win,text='del',command=del_entry).grid(row=1,column=3,stick='we',ipadx=40)#создание кнопки - фун-ция которой
# удалять у name ее значение

tk.Button(win,text='insert',command=insert_entry).grid(row=1,column=4,stick='we',ipadx=40)#создание кнопки - фун-ция которой
