...
for i in range (len(last_name)):
    a=last_name[i]+" "+name[i]+" "+second_name[i]+" "+date_of_birth[i]+" "
...
#Пересобираем массив ставим id на первое место
for i in range(len(student_names)):
    qr=Random_qr()
...
#Перебор отсортированного массива (от а до я по группе)
